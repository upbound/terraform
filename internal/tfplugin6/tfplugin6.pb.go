...
const file_tfplugin6_proto_rawDesc = "" +
	"\n" +
	"\x0ftfplugin6.proto\x12\ttfplugin6\"<\n" +
	...
	"\rprovider_meta\x18\x05 \x01(\v2\x11.tfplugin6.SchemaR\fproviderMeta\x12`\n" +
	"\x13server_capabilities\x18\x06 \x01(\v2/.tfplugin6.GetProviderSchema.ServerCapabilitiesR\x12serverCapabilities\x1aU\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12'\n" +
	"\x05value\x18\x02 \x01(\v2\x11.tfplugin6.SchemaR\x05value:\x028\x01\x1ax\n" +
	"\x12ServerCapabilities\x12!\n" +
	"\fplan_destroy\x18\x01 \x01(\bR\vplanDestroy\x12?\n" +
	"\x1cget_provider_schema_optional\x18\x02 \x01(\bR\x19getProviderSchemaOptional\"\x99\x01\n" +
	...
	"\vdiagnostics\x18\x02 \x03(\v2\x15.tfplugin6.DiagnosticR\vdiagnostics\"\xb6\x01\n" +
	"\x16ValidateResourceConfig\x1aW\n" +
	"\aRequest\x12\x1b\n" +
	"\ttype_name\x18\x01 \x01(\tR\btypeName\x12/\n" +
	...
	"\x06config\x18\x02 \x01(\v2\x17.tfplugin6.DynamicValueR\x06config\x1aC\n" +
	"\bResponse\x127\n" +
	"\vdiagnostics\x18\x01 \x03(\v2\x15.tfplugin6.DiagnosticR\vdiagnostics\"\xc1\x01\n" +
	"\x11ConfigureProvider\x1ag\n" +
	"\aRequest\x12+\n" +
	"\x11terraform_version\x18\x01 \x01(\tR\x10terraformVersion\x12/\n" +
	"\x06config\x18\x02 \x01(\v2\x17.tfplugin6.DynamicValueR\x06config\x1aC\n" +
	"\bResponse\x127\n" +
	"\vdiagnostics\x18\x01 \x03(\v2\x15.tfplugin6.DiagnosticR\vdiagnostics\"\xe3\x02\n" +
	...
	"\rprovider_meta\x18\x04 \x01(\v2\x17.tfplugin6.DynamicValueR\fproviderMeta\x1a\x93\x01\n" +
	"\bResponse\x124\n" +
	...
	"\rprovider_meta\x18\x06 \x01(\v2\x17.tfplugin6.DynamicValueR\fproviderMeta\x1a\x9d\x02\n" +
	"\bResponse\x12<\n" +
	...
	"\rprovider_meta\x18\x06 \x01(\v2\x17.tfplugin6.DynamicValueR\fproviderMeta\x1a\xc1\x01\n" +
	"\bResponse\x124\n" +
	...
	"\vdiagnostics\x18\x02 \x03(\v2\x15.tfplugin6.DiagnosticR\vdiagnostics\"\x9c\x02\n" +
	"\x0eReadDataSource\x1a\x95\x01\n" +
	"\aRequest\x12\x1b\n" +
	"\ttype_name\x18\x01 \x01(\tR\btypeName\x12/\n" +
	"\x06config\x18\x02 \x01(\v2\x17.tfplugin6.DynamicValueR\x06config\x12<\n" +
	"\rprovider_meta\x18\x03 \x01(\v2\x17.tfplugin6.DynamicValueR\fproviderMeta\x1ar\n" +
	"\bResponse\x12-\n" +
...
func file_tfplugin6_proto_init() {
	...
	file_tfplugin6_proto_msgTypes[17].OneofWrappers = []any{
