...
const file_planfile_proto_rawDesc = "" +
	"\n" +
	"\x0eplanfile.proto\x12\x06tfplan\"\xdf\x06\n" +
	"\x04Plan\x12\x18\n" +
	...
	"\tsensitive\x18\x03 \x01(\bR\tsensitive\"\xe8\x03\n" +
	"\fCheckResults\x123\n" +
	...
	"\x12CREATE_THEN_DELETE\x10\a*\xc8\x03\n" +
	...
	"\x1dDELETE_BECAUSE_NO_MOVE_TARGET\x10\fBBZ@github.com/hashicorp/terraform/internal/plans/internal/planprotob\x06proto3"
